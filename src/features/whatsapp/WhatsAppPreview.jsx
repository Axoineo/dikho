...
export function WhatsAppPreview({ template, businessName = 'Dikho' }) {
    ...
    <div className={shell}>
      ...
      <div className="flex min-h-[250px] flex-col gap-2 bg-wa-canvas px-3 pb-5 pt-4" style={CANVAS_TEXTURE}>
        <div className="relative max-w-[85%] self-end rounded-lg rounded-tr-[2px] bg-wa-bubble
          ...
          {template.headerText && <div className="mb-[3px] font-bold">{template.headerText}</div>}

          <div className="whitespace-pre-wrap break-words">{template.bodyText}</div>
